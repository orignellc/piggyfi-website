  ...
  return (
    <div className="bg-black">
      <div className="bg-gradient-to-br from-purple-hero to-black-hero">
        <div className="max-w-6xl px-4 w-full flex items-center mx-auto py-14 md:py-16 grid sm:grid-cols-2 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <button className="text-white py-5 px-11 rounded-2xl btn-bg-gradient-purple">
              Join the wait list
            </button>
          </div>
        </div>
